...
GSE51820_path <- paste(wdPath, "GSE51820/GSE51820_series_matrix.txt.gz", sep="")
GSE133556_path <- paste(wdPath, "GSE133556/GSE133556_series_matrix.txt.gz", sep="")
GSE155760_path <- paste(wdPath, "GSE155760/GSE155760_series_matrix.txt.gz", sep="")
GSE185008_1_path <- paste(wdPath, "GSE185008/GSE185008-GPL13534_series_matrix.txt.gz", sep="")
GSE185008_2_path <- paste(wdPath, "GSE185008/GSE185008-GPL21145_series_matrix.txt.gz", sep="")
GSE211686_1_path <- paste(wdPath, "GSE211686/GSE211686-GPL13534_series_matrix.txt.gz", sep="")
GSE211686_2_path <- paste(wdPath, "GSE211686/GSE211686-GPL21145_series_matrix.txt.gz", sep="")
GSE226823_path <- paste(wdPath, "GSE226823/GSE226823_series_matrix.txt.gz", sep="")
GSE226872_1_path <- paste(wdPath, "GSE226872/GSE226872-GPL13534_series_matrix.txt.gz", sep="")
GSE226872_2_path <- paste(wdPath, "GSE226872/GSE226872-GPL16791_series_matrix.txt.gz", sep="")
GSE263434_path <- paste(wdPath, "GSE263434/GSE263434_series_matrix.txt.gz", sep="")
GSE267068_path <- paste(wdPath, "GSE267068/GSE267068_series_matrix.txt.gz", sep="")
trainPath <- paste(wdPath, "Train/GSE326000_series_matrix.txt.gz", sep="")
...
gse51820_supp <- getGEOSuppFiles("GSE51820", makeDirectory = TRUE, baseDir = paste(wdPath, "GSE51820/", sep=""))
...
gse51820_beta_raw <- readGEORawFile(paste(wdPath, "GSE51820/GSE51820_non_normalized.txt.gz", sep=""), 
                                    sep = "\t", 
...
gse51820_beta <- champ.norm(beta=gse51820_Filter$beta,
                            resultsDir=paste(wdPath, "51820/CHAMP_Normalization/", sep=""),
                            method="BMIQ",
                            plotBMIQ=FALSE,
                            arraytype="450K",
                            cores=6)
...
makeMethBetaFreqPlt(inpBeta = as.data.frame(gse51820_beta), inpPheno = gse51820_pheno, inpSid = "GSE51820", inpDir = paste(wdPath, "GSE51820/",sep=""))

write.csv(gse51820_pheno, paste(wdPath, "GSE51820/GSE51820_pheno.csv", sep=""), row.names = TRUE)
write.csv(gse51820_beta, paste(wdPath, "GSE51820/GSE51820_Beta.csv", sep=""))
...
GSE133556_pheno$Basename <- paste(wdPath, "GSE133556/", GSE133556_pheno$Basename, sep="")
...
write.csv(gse133556_pheno , paste(wdPath, "GSE133556/GSE133556_pheno.csv", sep=""))
...
gse155760_pheno$Basename <- paste(wdPath, "GSE155760/", gse155760_pheno$Basename, sep="")
...
write.csv(gse155760_pheno, paste(wdPath, "GSE155760/gse155760_pheno.csv",sep=""))
...
GSE185008_1_pheno$Basename <- paste(wdPath, "GSE185008/", GSE185008_1_pheno$Basename, sep="")
...
write.csv(gse185008_1_pheno, paste(wdPath, "GSE185008/GSE185008_1_pheno.csv", sep=""))
...
GSE185008_2_pheno$Basename <- paste(wdPath, "GSE185008/", GSE185008_2_pheno$Basename, sep="")
...
# Save phenotypic manifest to local drive for future use
write.csv(gse185008_2_pheno, paste(wdPath, "GSE185008/GSE185008_2_pheno.csv", sep=""))
...
GSE211686_1_pheno$Basename <- paste(wdPath, "GSE211686/", GSE211686_1_pheno$Basename, sep="")  
...
GSE211686_1_pheno$Histotype <- plyr::mapvalues(
  ...
  c("HGSC"))
# Save phenotypic manifest to local drive for future use
write.csv(GSE211686_1_pheno, paste(wdPath, "GSE211686/GSE211686_1_pheno.csv", sep=""))
...
GSE211686_2_pheno$Basename <- paste(wdPath, "GSE211686/", GSE211686_2_pheno$Basename, sep="")
...
GSE211686_2_pheno$Histotype <- plyr::mapvalues(
  ...
  c("HGSC"))
# Save phenotypic manifest to local drive for future use
write.csv(GSE211686_2_pheno, paste(wdPath, "GSE211686/GSE211686_2_pheno.csv", sep=""))
...
gse226823_pheno$Basename <- paste(wdPath, "GSE226823/", gse226823_pheno$Basename, sep="")
...
# Save phenotypic manifest to local drive for future use
write.csv(gse226823_pheno, paste(wdPath, "GSE226823/GSE226823_pheno.csv", sep=""))
...
gse263434_pheno$Basename <- paste(wdPath, "GSE263434/", gse263434_pheno$Basename, sep="")
...
write.csv(gse263434_pheno, paste(wdPath, "GSE263434/gse263434_pheno.csv",sep=""))
...
gse267068_pheno$Basename <- paste(wdPath, "GSE267068/", gse267068_pheno$Basename, sep="")
...
write.csv(gse267068_pheno, paste(wdPath, "GSE267068/gse267068_pheno.csv", sep=""))
...
trainPheno$Basename <- paste(wdPath, "Train/", trainPheno$Basename, sep="")
...
write.csv(trainPheno, paste(wdPath, "Train/trainPheno.csv",sep=""))
